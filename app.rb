...
route :get, :post, '/' do
	...
	if params[:title] && params[:shelving_location] && params[:call_number]
		...
		html_content = '<html><body><head><link rel="stylesheet" type="text/css" href="'+ working_directory +'/style.css"></head><div id="container"><center><img src="'+ working_directory +'/logo.png" width="170px"></center>' + item + '</div></body></html>'
		...
		message = {:message => 'Correct parameters ' + dimensions[1].to_s}	
		html_file.unlink
	        image_file.unlink
	else
